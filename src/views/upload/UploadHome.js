...
const UploadHome = () => {
    ...
    const [ubication,setUbication] = useState("Merida")
    ...
    const Upload = async (e)=>{
        ...
        formData.append('yearConstruction', yearConstruction)
                ...
                <div className="col-xl-6 col-lg-6">
                    ...
                    <form >
                        ...
                        <div className="p-3">
                            ...
                            <input onChange={(e)=>setYearConstruction(e.target.value)} className="form-control" type="text" />
                        </div>
